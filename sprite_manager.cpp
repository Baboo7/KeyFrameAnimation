...
void InitialiseSpritesPositionOnAnimationRect (vector<sprite_t *> *sprites_displaying, int X_o, int Y_o, int width, int height)
{
    int X = X_o ;
    int Y = Y_o ;
...
int GetSpriteTableIndex(sprite_t* spr, std::vector<sprite_t *> &table)
{
    ...
    // Le sprite n'a pas été trouvé, on retourne -1.
    return -1 ;
}
